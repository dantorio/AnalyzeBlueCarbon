...
The core from marginal eelgrass has more organic carbon than the core from healthy looking eelgrass see Table 1. 
...
knitr::kable(cpercent, format = "markdown", caption = "Summary Statistics of Percent Organic Carbon")
